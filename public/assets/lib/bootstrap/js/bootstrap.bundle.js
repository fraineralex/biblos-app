...
(function (global, factory) {
  ...
  function mapToStyles(_ref2) {
    ...
    if (gpuAcceleration) {
      ...
      return { ...commonStyles, ...(_Object$assign = {}, _Object$assign[sideY] = hasY ? '0' : '', _Object$assign[sideX] = hasX ? '0' : '', _Object$assign.transform = (win.devicePixelRatio || 1) <= 1 ? `translate(${x}px, ${y}px)` : `translate3d(${x}px, ${y}px, 0)`, _Object$assign) };
    }
