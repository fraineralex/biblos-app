...
!(function (t, e) { typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = e(require('@popperjs/core')) : typeof define === 'function' && define.amd ? define(['@popperjs/core'], e) : (t = typeof globalThis !== 'undefined' ? globalThis : t || self).bootstrap = e(t.Popper); }(this, ((t) => {
  function e(t) { const e = Object.create(null, { [Symbol.toStringTag]: { value: 'Module' } }); if (t) for (const s in t) if (s !== 'default') { const i = Object.getOwnPropertyDescriptor(t, s); Object.defineProperty(e, s, i.get ? i : { enumerable: !0, get: () => t[s] }); } return e.default = t, Object.freeze(e); } const s = e(t); const i = 'transitionend'; const n = (t) => (t && window.CSS && window.CSS.escape && (t = t.replace(/#([^\s"#']+)/g, ((t, e) => `#${CSS.escape(e)}`))), t); const o = (t) => { t.dispatchEvent(new Event(i)); }; const r = (t) => !(!t || typeof t !== 'object') && (void 0 !== t.jquery && (t = t[0]), void 0 !== t.nodeType); const a = (t) => (r(t) ? t.jquery ? t[0] : t : typeof t === 'string' && t.length > 0 ? document.querySelector(n(t)) : null); const l = (t) => { if (!r(t) || t.getClientRects().length === 0) return !1; const e = getComputedStyle(t).getPropertyValue('visibility') === 'visible'; const s = t.closest('details:not([open])'); if (!s) return e; if (s !== t) { const e = t.closest('summary'); if (e && e.parentNode !== s) return !1; if (e === null) return !1; } return e; }; const c = (t) => !t || t.nodeType !== Node.ELEMENT_NODE || !!t.classList.contains('disabled') || (void 0 !== t.disabled ? t.disabled : t.hasAttribute('disabled') && t.getAttribute('disabled') !== 'false'); const h = (t) => { if (!document.documentElement.attachShadow) return null; if (typeof t.getRootNode === 'function') { const e = t.getRootNode(); return e instanceof ShadowRoot ? e : null; } return t instanceof ShadowRoot ? t : t.parentNode ? h(t.parentNode) : null; }; const d = () => {}; const u = (t) => { t.offsetHeight; }; const _ = () => (window.jQuery && !document.body.hasAttribute('data-bs-no-jquery') ? window.jQuery : null); const g = []; const f = () => document.documentElement.dir === 'rtl'; const m = (t) => { let e; e = () => { const e = _(); if (e) { const s = t.NAME; const i = e.fn[s]; e.fn[s] = t.jQueryInterface, e.fn[s].Constructor = t, e.fn[s].noConflict = () => (e.fn[s] = i, t.jQueryInterface); } }, document.readyState === 'loading' ? (g.length || document.addEventListener('DOMContentLoaded', (() => { for (const t of g)t(); })), g.push(e)) : e(); }; const p = (t, e = [], s = t) => (typeof t === 'function' ? t(...e) : s); const b = (t, e, s = !0) => { if (!s) return void p(t); const n = ((t) => { if (!t) return 0; let { transitionDuration: e, transitionDelay: s } = window.getComputedStyle(t); const i = Number.parseFloat(e); const n = Number.parseFloat(s); return i || n ? (e = e.split(',')[0], s = s.split(',')[0], 1e3 * (Number.parseFloat(e) + Number.parseFloat(s))) : 0; })(e) + 5; let r = !1; const a = ({ target: s }) => { s === e && (r = !0, e.removeEventListener(i, a), p(t)); }; e.addEventListener(i, a), setTimeout((() => { r || o(e); }), n); }; const v = (t, e, s, i) => { const n = t.length; let o = t.indexOf(e); return o === -1 ? !s && i ? t[n - 1] : t[0] : (o += s ? 1 : -1, i && (o = (o + n) % n), t[Math.max(0, Math.min(o, n - 1))]); }; const y = /[^.]*(?=\..*)\.|.*/; const w = /\..*/; const A = /::\d+$/; const E = {}; let C = 1; const T = { mouseenter: 'mouseover', mouseleave: 'mouseout' }; const k = new Set(['click', 'dblclick', 'mouseup', 'mousedown', 'contextmenu', 'mousewheel', 'DOMMouseScroll', 'mouseover', 'mouseout', 'mousemove', 'selectstart', 'selectend', 'keydown', 'keypress', 'keyup', 'orientationchange', 'touchstart', 'touchmove', 'touchend', 'touchcancel', 'pointerdown', 'pointermove', 'pointerup', 'pointerleave', 'pointercancel', 'gesturestart', 'gesturechange', 'gestureend', 'focus', 'blur', 'change', 'reset', 'select', 'submit', 'focusin', 'focusout', 'load', 'unload', 'beforeunload', 'resize', 'move', 'DOMContentLoaded', 'readystatechange', 'error', 'abort', 'scroll']); function S(t, e) { return e && `${e}::${C++}` || t.uidEvent || C++; } function L(t) { const e = S(t); return t.uidEvent = e, E[e] = E[e] || {}, E[e]; } function O(t, e, s = null) { return Object.values(t).find(((t) => t.callable === e && t.delegationSelector === s)); } function I(t, e, s) { const i = typeof e === 'string'; const n = i ? s : e || s; let o = x(t); return k.has(o) || (o = t), [i, n, o]; } function D(t, e, s, i, n) { if (typeof e !== 'string' || !t) return; let [o, r, a] = I(e, s, i); if (e in T) { const t = (t) => function (e) { if (!e.relatedTarget || e.relatedTarget !== e.delegateTarget && !e.delegateTarget.contains(e.relatedTarget)) return t.call(this, e); }; r = t(r); } const l = L(t); const c = l[a] || (l[a] = {}); const h = O(c, r, o ? s : null); if (h) return void (h.oneOff = h.oneOff && n); const d = S(r, e.replace(y, '')); const u = o ? (function (t, e, s) { return function i(n) { const o = t.querySelectorAll(e); for (let { target: r } = n; r && r !== this; r = r.parentNode) for (const a of o) if (a === r) return j(n, { delegateTarget: r }), i.oneOff && M.off(t, n.type, e, s), s.apply(r, [n]); }; }(t, s, r)) : (function (t, e) { return function s(i) { return j(i, { delegateTarget: t }), s.oneOff && M.off(t, i.type, e), e.apply(t, [i]); }; }(t, r)); u.delegationSelector = o ? s : null, u.callable = r, u.oneOff = n, u.uidEvent = d, c[d] = u, t.addEventListener(a, u, o); } function N(t, e, s, i, n) { const o = O(e[s], i, n); o && (t.removeEventListener(s, o, Boolean(n)), delete e[s][o.uidEvent]); } function P(t, e, s, i) { const n = e[s] || {}; for (const [o, r] of Object.entries(n))o.includes(i) && N(t, e, s, r.callable, r.delegationSelector); } function x(t) { return t = t.replace(w, ''), T[t] || t; } const M = {
    on(t, e, s, i) { D(t, e, s, i, !1); }, one(t, e, s, i) { D(t, e, s, i, !0); }, off(t, e, s, i) { if (typeof e !== 'string' || !t) return; const [n, o, r] = I(e, s, i); const a = r !== e; const l = L(t); const c = l[r] || {}; const h = e.startsWith('.'); if (void 0 === o) { if (h) for (const s of Object.keys(l))P(t, l, s, e.slice(1)); for (const [s, i] of Object.entries(c)) { const n = s.replace(A, ''); a && !e.includes(n) || N(t, l, r, i.callable, i.delegationSelector); } } else { if (!Object.keys(c).length) return; N(t, l, r, o, n ? s : null); } }, trigger(t, e, s) { if (typeof e !== 'string' || !t) return null; const i = _(); let n = null; let o = !0; let r = !0; let a = !1; e !== x(e) && i && (n = i.Event(e, s), i(t).trigger(n), o = !n.isPropagationStopped(), r = !n.isImmediatePropagationStopped(), a = n.isDefaultPrevented()); let l = new Event(e, { bubbles: o, cancelable: !0 }); return l = j(l, s), a && l.preventDefault(), r && t.dispatchEvent(l), l.defaultPrevented && n && n.preventDefault(), l; },
  }; function j(t, e = {}) { for (const [s, i] of Object.entries(e)) try { t[s] = i; } catch (e) { Object.defineProperty(t, s, { configurable: !0, get: () => i }); } return t; } const F = new Map(); const
    $ = { set(t, e, s) { F.has(t) || F.set(t, new Map()); const i = F.get(t); i.has(e) || i.size === 0 ? i.set(e, s) : console.error(`Bootstrap doesn't allow more than one instance per element. Bound instance: ${Array.from(i.keys())[0]}.`); }, get: (t, e) => F.has(t) && F.get(t).get(e) || null, remove(t, e) { if (!F.has(t)) return; const s = F.get(t); s.delete(e), s.size === 0 && F.delete(t); } }; function z(t) { if (t === 'true') return !0; if (t === 'false') return !1; if (t === Number(t).toString()) return Number(t); if (t === '' || t === 'null') return null; if (typeof t !== 'string') return t; try { return JSON.parse(decodeURIComponent(t)); } catch (e) { return t; } } function H(t) { return t.replace(/[A-Z]/g, ((t) => `-${t.toLowerCase()}`)); } const B = {
    ...
    _mergeConfigObj(t, e) {
      const s = r(e) ? B.getDataAttribute(e, 'config') : {}; return {
        ...this.constructor.Default, ...typeof s === 'object' ? s : {}, ...r(e) ? B.getDataAttributes(e) : {}, ...typeof t === 'object' ? t : {},
      };
    }

    _typeCheckConfig(t, e = this.constructor.DefaultType) { for (const [i, n] of Object.entries(e)) { const e = t[i]; const o = r(e) ? 'element' : (s = e) == null ? `${s}` : Object.prototype.toString.call(s).match(/\s([a-z]+)/i)[1].toLowerCase(); if (!new RegExp(n).test(o)) throw new TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${i}" provided type "${o}" but expected type "${n}".`); } let s; }
  } class W extends q {
    constructor(t, e) { super(), (t = a(t)) && (this._element = t, this._config = this._getConfig(e), $.set(this._element, this.constructor.DATA_KEY, this)); }

    dispose() { $.remove(this._element, this.constructor.DATA_KEY), M.off(this._element, this.constructor.EVENT_KEY); for (const t of Object.getOwnPropertyNames(this)) this[t] = null; }

    _queueCallback(t, e, s = !0) { b(t, e, s); }

    _getConfig(t) { return t = this._mergeConfigObj(t, this._element), t = this._configAfterMerge(t), this._typeCheckConfig(t), t; }

    static getInstance(t) { return $.get(a(t), this.DATA_KEY); }
  ...
  } const R = (t) => { let e = t.getAttribute('data-bs-target'); if (!e || e === '#') { let s = t.getAttribute('href'); if (!s || !s.includes('#') && !s.startsWith('.')) return null; s.includes('#') && !s.startsWith('#') && (s = `#${s.split('#')[1]}`), e = s && s !== '#' ? s.trim() : null; } return n(e); }; const V = {
    find: (t, e = document.documentElement) => [].concat(...Element.prototype.querySelectorAll.call(e, t)), findOne: (t, e = document.documentElement) => Element.prototype.querySelector.call(e, t), children: (t, e) => [].concat(...t.children).filter(((t) => t.matches(e))), parents(t, e) { const s = []; let i = t.parentNode.closest(e); for (;i;)s.push(i), i = i.parentNode.closest(e); return s; }, prev(t, e) { let s = t.previousElementSibling; for (;s;) { if (s.matches(e)) return [s]; s = s.previousElementSibling; } return []; }, next(t, e) { let s = t.nextElementSibling; for (;s;) { if (s.matches(e)) return [s]; s = s.nextElementSibling; } return []; }, focusableChildren(t) { const e = ['a', 'button', 'input', 'textarea', 'select', 'details', '[tabindex]', '[contenteditable="true"]'].map(((t) => `${t}:not([tabindex^="-"])`)).join(','); return this.find(e, t).filter(((t) => !c(t) && l(t))); }, getSelectorFromElement(t) { const e = R(t); return e && V.findOne(e) ? e : null; }, getElementFromSelector(t) { const e = R(t); return e ? V.findOne(e) : null; }, getMultipleElementsFromSelector(t) { const e = R(t); return e ? V.find(e) : []; },
  }; const K = (t, e = 'hide') => { const s = `click.dismiss${t.EVENT_KEY}`; const i = t.NAME; M.on(document, s, `[data-bs-dismiss="${i}"]`, (function (s) { if (['A', 'AREA'].includes(this.tagName) && s.preventDefault(), c(this)) return; const n = V.getElementFromSelector(this) || this.closest(`.${i}`); t.getOrCreateInstance(n)[e](); })); }; class Q extends W {
    static get NAME() { return 'alert'; }

    close() { if (M.trigger(this._element, 'close.bs.alert').defaultPrevented) return; this._element.classList.remove('show'); const t = this._element.classList.contains('fade'); this._queueCallback((() => this._destroyElement()), this._element, t); }
  ...
  }K(Q, 'close'), m(Q); const X = '[data-bs-toggle="button"]'; class Y extends W {
    static get NAME() { return 'button'; }

    toggle() { this._element.setAttribute('aria-pressed', this._element.classList.toggle('active')); }

    static jQueryInterface(t) { return this.each((function () { const e = Y.getOrCreateInstance(this); t === 'toggle' && e[t](); })); }
  }M.on(document, 'click.bs.button.data-api', X, ((t) => { t.preventDefault(); const e = t.target.closest(X); Y.getOrCreateInstance(e).toggle(); })), m(Y); const U = { endCallback: null, leftCallback: null, rightCallback: null }; const G = { endCallback: '(function|null)', leftCallback: '(function|null)', rightCallback: '(function|null)' }; class J extends q {
    ...
    _maybeEnableCycle() { this._config.ride && (this._isSliding ? M.one(this._element, it, (() => this.cycle())) : this.cycle()); }

    to(t) { const e = this._getItems(); if (t > e.length - 1 || t < 0) return; if (this._isSliding) return void M.one(this._element, it, (() => this.to(t))); const s = this._getItemIndex(this._getActive()); if (s === t) return; const i = t > s ? Z : tt; this._slide(i, e[t]); }

    dispose() { this._swipeHelper && this._swipeHelper.dispose(), super.dispose(); }

    _configAfterMerge(t) { return t.defaultInterval = t.interval, t; }

    _addEventListeners() { this._config.keyboard && M.on(this._element, 'keydown.bs.carousel', ((t) => this._keydown(t))), this._config.pause === 'hover' && (M.on(this._element, 'mouseenter.bs.carousel', (() => this.pause())), M.on(this._element, 'mouseleave.bs.carousel', (() => this._maybeEnableCycle()))), this._config.touch && J.isSupported() && this._addTouchEventListeners(); }

    _addTouchEventListeners() { for (const t of V.find('.carousel-item img', this._element))M.on(t, 'dragstart.bs.carousel', ((t) => t.preventDefault())); const t = { leftCallback: () => this._slide(this._directionToOrder(et)), rightCallback: () => this._slide(this._directionToOrder(st)), endCallback: () => { this._config.pause === 'hover' && (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), this.touchTimeout = setTimeout((() => this._maybeEnableCycle()), 500 + this._config.interval)); } }; this._swipeHelper = new J(this._element, t); }
    ...
    _slide(t, e = null) {
      if (this._isSliding) return; const s = this._getActive(); const i = t === Z; const n = e || v(this._getItems(), s, i, this._config.wrap); if (n === s) return; const o = this._getItemIndex(n); const r = (e) => M.trigger(this._element, e, {
        relatedTarget: n, direction: this._orderToDirection(t), from: this._getItemIndex(s), to: o,
      }); if (r('slide.bs.carousel').defaultPrevented) return; if (!s || !n) return; const a = Boolean(this._interval); this.pause(), this._isSliding = !0, this._setActiveIndicatorElement(o), this._activeElement = n; const l = i ? 'carousel-item-start' : 'carousel-item-end'; const c = i ? 'carousel-item-next' : 'carousel-item-prev'; n.classList.add(c), u(n), s.classList.add(l), n.classList.add(l), this._queueCallback((() => { n.classList.remove(l, c), n.classList.add(ot), s.classList.remove(ot, c, l), this._isSliding = !1, r(it); }), s, this._isAnimated()), a && this.cycle();
    }
    ...
    _directionToOrder(t) { return f() ? t === et ? tt : Z : t === et ? Z : tt; }

    _orderToDirection(t) { return f() ? t === tt ? et : st : t === tt ? st : et; }
  ...
  }M.on(document, 'click.bs.carousel.data-api', '[data-bs-slide], [data-bs-slide-to]', (function (t) { const e = V.getElementFromSelector(this); if (!e || !e.classList.contains(nt)) return; t.preventDefault(); const s = ct.getOrCreateInstance(e); const i = this.getAttribute('data-bs-slide-to'); return i ? (s.to(i), void s._maybeEnableCycle()) : B.getDataAttribute(this, 'slide') === 'next' ? (s.next(), void s._maybeEnableCycle()) : (s.prev(), void s._maybeEnableCycle()); })), M.on(window, 'load.bs.carousel.data-api', (() => { const t = V.find('[data-bs-ride="carousel"]'); for (const e of t)ct.getOrCreateInstance(e); })), m(ct); const ht = 'show'; const dt = 'collapse'; const ut = 'collapsing'; const _t = '[data-bs-toggle="collapse"]'; const gt = { parent: null, toggle: !0 }; const ft = { parent: '(null|element)', toggle: 'boolean' }; class mt extends W {
  ...
  }M.on(document, 'click.bs.collapse.data-api', _t, (function (t) { (t.target.tagName === 'A' || t.delegateTarget && t.delegateTarget.tagName === 'A') && t.preventDefault(); for (const t of V.getMultipleElementsFromSelector(this))mt.getOrCreateInstance(t, { toggle: !1 }).toggle(); })), m(mt); const pt = 'dropdown'; const bt = 'ArrowUp'; const vt = 'ArrowDown'; const yt = 'click.bs.dropdown.data-api'; const wt = 'keydown.bs.dropdown.data-api'; const At = 'show'; const Et = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)'; const Ct = `${Et}.show`; const Tt = '.dropdown-menu'; const kt = f() ? 'top-end' : 'top-start'; const St = f() ? 'top-start' : 'top-end'; const Lt = f() ? 'bottom-end' : 'bottom-start'; const Ot = f() ? 'bottom-start' : 'bottom-end'; const It = f() ? 'left-start' : 'right-start'; const Dt = f() ? 'right-start' : 'left-start'; const Nt = {
    ...
    _completeHide(t) { if (!M.trigger(this._element, 'hide.bs.dropdown', t).defaultPrevented) { if ('ontouchstart' in document.documentElement) for (const t of [].concat(...document.body.children))M.off(t, 'mouseover', d); this._popper && this._popper.destroy(), this._menu.classList.remove(At), this._element.classList.remove(At), this._element.setAttribute('aria-expanded', 'false'), B.removeDataAttribute(this._menu, 'popper'), M.trigger(this._element, 'hidden.bs.dropdown', t); } }

    _getConfig(t) { if (typeof (t = super._getConfig(t)).reference === 'object' && !r(t.reference) && typeof t.reference.getBoundingClientRect !== 'function') throw new TypeError(`${pt.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`); return t; }

    _createPopper() { if (void 0 === s) throw new TypeError('Bootstrap\'s dropdowns require Popper (https://popper.js.org)'); let t = this._element; this._config.reference === 'parent' ? t = this._parent : r(this._config.reference) ? t = a(this._config.reference) : typeof this._config.reference === 'object' && (t = this._config.reference); const e = this._getPopperConfig(); this._popper = s.createPopper(t, this._menu, e); }
    ...
    _getPopperConfig() { const t = { placement: this._getPlacement(), modifiers: [{ name: 'preventOverflow', options: { boundary: this._config.boundary } }, { name: 'offset', options: { offset: this._getOffset() } }] }; return (this._inNavbar || this._config.display === 'static') && (B.setDataAttribute(this._menu, 'popper', 'static'), t.modifiers = [{ name: 'applyStyles', enabled: !1 }]), { ...t, ...p(this._config.popperConfig, [t]) }; }

    _selectMenuItem({ key: t, target: e }) { const s = V.find('.dropdown-menu .dropdown-item:not(.disabled):not(:disabled)', this._menu).filter(((t) => l(t))); s.length && v(s, e, t === vt, !s.includes(e)).focus(); }
  ...
  }M.on(document, wt, Et, xt.dataApiKeydownHandler), M.on(document, wt, Tt, xt.dataApiKeydownHandler), M.on(document, yt, xt.clearMenus), M.on(document, 'keyup.bs.dropdown.data-api', xt.clearMenus), M.on(document, yt, Et, (function (t) { t.preventDefault(), xt.getOrCreateInstance(this).toggle(); })), m(xt); const Mt = '.fixed-top, .fixed-bottom, .is-fixed, .sticky-top'; const jt = '.sticky-top'; const Ft = 'padding-right'; const $t = 'margin-right'; class zt {
    constructor() { this._element = document.body; }

    getWidth() { const t = document.documentElement.clientWidth; return Math.abs(window.innerWidth - t); }

    hide() { const t = this.getWidth(); this._disableOverFlow(), this._setElementAttributes(this._element, Ft, ((e) => e + t)), this._setElementAttributes(Mt, Ft, ((e) => e + t)), this._setElementAttributes(jt, $t, ((e) => e - t)); }

    reset() { this._resetElementAttributes(this._element, 'overflow'), this._resetElementAttributes(this._element, Ft), this._resetElementAttributes(Mt, Ft), this._resetElementAttributes(jt, $t); }
    ...
    _applyManipulationCallback(t, e) { if (r(t))e(t); else for (const s of V.find(t, this._element))e(s); }
  } const Ht = 'show'; const Bt = 'mousedown.bs.backdrop'; const qt = {
    ...
    show(t) { if (!this._config.isVisible) return void p(t); this._append(); const e = this._getElement(); this._config.isAnimated && u(e), e.classList.add(Ht), this._emulateAnimation((() => { p(t); })); }

    hide(t) { this._config.isVisible ? (this._getElement().classList.remove(Ht), this._emulateAnimation((() => { this.dispose(), p(t); }))) : p(t); }

    dispose() { this._isAppended && (M.off(this._element, Bt), this._element.remove(), this._isAppended = !1); }
    ...
    _append() { if (this._isAppended) return; const t = this._getElement(); this._config.rootElement.append(t), M.on(t, Bt, (() => { p(this._config.clickCallback); })), this._isAppended = !0; }

    _emulateAnimation(t) { b(t, this._getElement(), this._config.isAnimated); }
  } const Vt = '.bs.focustrap'; const Kt = 'backward'; const Qt = { autofocus: !0, trapElement: null }; const Xt = { autofocus: 'boolean', trapElement: 'element' }; class Yt extends q {
    ...
    activate() { this._isActive || (this._config.autofocus && this._config.trapElement.focus(), M.off(document, Vt), M.on(document, 'focusin.bs.focustrap', ((t) => this._handleFocusin(t))), M.on(document, 'keydown.tab.bs.focustrap', ((t) => this._handleKeydown(t))), this._isActive = !0); }

    deactivate() { this._isActive && (this._isActive = !1, M.off(document, Vt)); }

    _handleFocusin(t) { const { trapElement: e } = this._config; if (t.target === document || t.target === e || e.contains(t.target)) return; const s = V.focusableChildren(e); s.length === 0 ? e.focus() : this._lastTabNavDirection === Kt ? s[s.length - 1].focus() : s[0].focus(); }

    _handleKeydown(t) { t.key === 'Tab' && (this._lastTabNavDirection = t.shiftKey ? Kt : 'forward'); }
  } const Ut = 'hidden.bs.modal'; const Gt = 'show.bs.modal'; const Jt = 'modal-open'; const Zt = 'show'; const te = 'modal-static'; const ee = { backdrop: !0, focus: !0, keyboard: !0 }; const se = { backdrop: '(boolean|string)', focus: 'boolean', keyboard: 'boolean' }; class ie extends W {
    constructor(t, e) { super(t, e), this._dialog = V.findOne('.modal-dialog', this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._isTransitioning = !1, this._scrollBar = new zt(), this._addEventListeners(); }
    ...
    show(t) { this._isShown || this._isTransitioning || M.trigger(this._element, Gt, { relatedTarget: t }).defaultPrevented || (this._isShown = !0, this._isTransitioning = !0, this._scrollBar.hide(), document.body.classList.add(Jt), this._adjustDialog(), this._backdrop.show((() => this._showElement(t)))); }

    hide() { this._isShown && !this._isTransitioning && (M.trigger(this._element, 'hide.bs.modal').defaultPrevented || (this._isShown = !1, this._isTransitioning = !0, this._focustrap.deactivate(), this._element.classList.remove(Zt), this._queueCallback((() => this._hideModal()), this._element, this._isAnimated()))); }

    dispose() { for (const t of [window, this._dialog])M.off(t, '.bs.modal'); this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose(); }
    ...
    _addEventListeners() { M.on(this._element, 'keydown.dismiss.bs.modal', ((t) => { if (t.key === 'Escape') return this._config.keyboard ? (t.preventDefault(), void this.hide()) : void this._triggerBackdropTransition(); })), M.on(window, 'resize.bs.modal', (() => { this._isShown && !this._isTransitioning && this._adjustDialog(); })), M.on(this._element, 'mousedown.dismiss.bs.modal', ((t) => { M.one(this._element, 'click.dismiss.bs.modal', ((e) => { this._element === t.target && this._element === e.target && (this._config.backdrop !== 'static' ? this._config.backdrop && this.hide() : this._triggerBackdropTransition()); })); })); }

    _hideModal() { this._element.style.display = 'none', this._element.setAttribute('aria-hidden', !0), this._element.removeAttribute('aria-modal'), this._element.removeAttribute('role'), this._isTransitioning = !1, this._backdrop.hide((() => { document.body.classList.remove(Jt), this._resetAdjustments(), this._scrollBar.reset(), M.trigger(this._element, Ut); })); }

    _isAnimated() { return this._element.classList.contains('fade'); }

    _triggerBackdropTransition() { if (M.trigger(this._element, 'hidePrevented.bs.modal').defaultPrevented) return; const t = this._element.scrollHeight > document.documentElement.clientHeight; const e = this._element.style.overflowY; e === 'hidden' || this._element.classList.contains(te) || (t || (this._element.style.overflowY = 'hidden'), this._element.classList.add(te), this._queueCallback((() => { this._element.classList.remove(te), this._queueCallback((() => { this._element.style.overflowY = e; }), this._dialog); }), this._dialog), this._element.focus()); }

    _adjustDialog() { const t = this._element.scrollHeight > document.documentElement.clientHeight; const e = this._scrollBar.getWidth(); const s = e > 0; if (s && !t) { const t = f() ? 'paddingLeft' : 'paddingRight'; this._element.style[t] = `${e}px`; } if (!s && t) { const t = f() ? 'paddingRight' : 'paddingLeft'; this._element.style[t] = `${e}px`; } }

    _resetAdjustments() { this._element.style.paddingLeft = '', this._element.style.paddingRight = ''; }

    static jQueryInterface(t, e) { return this.each((function () { const s = ie.getOrCreateInstance(this, t); if (typeof t === 'string') { if (void 0 === s[t]) throw new TypeError(`No method named "${t}"`); s[t](e); } })); }
  }M.on(document, 'click.bs.modal.data-api', '[data-bs-toggle="modal"]', (function (t) { const e = V.getElementFromSelector(this); ['A', 'AREA'].includes(this.tagName) && t.preventDefault(), M.one(e, Gt, ((t) => { t.defaultPrevented || M.one(e, Ut, (() => { l(this) && this.focus(); })); })); const s = V.findOne('.modal.show'); s && ie.getInstance(s).hide(), ie.getOrCreateInstance(e).toggle(this); })), K(ie), m(ie); const ne = 'show'; const oe = 'showing'; const re = 'hiding'; const ae = '.offcanvas.show'; const le = 'hidePrevented.bs.offcanvas'; const ce = 'hidden.bs.offcanvas'; const he = { backdrop: !0, keyboard: !0, scroll: !1 }; const de = { backdrop: '(boolean|string)', keyboard: 'boolean', scroll: 'boolean' }; class ue extends W {
    ...
    show(t) { this._isShown || M.trigger(this._element, 'show.bs.offcanvas', { relatedTarget: t }).defaultPrevented || (this._isShown = !0, this._backdrop.show(), this._config.scroll || (new zt()).hide(), this._element.setAttribute('aria-modal', !0), this._element.setAttribute('role', 'dialog'), this._element.classList.add(oe), this._queueCallback((() => { this._config.scroll && !this._config.backdrop || this._focustrap.activate(), this._element.classList.add(ne), this._element.classList.remove(oe), M.trigger(this._element, 'shown.bs.offcanvas', { relatedTarget: t }); }), this._element, !0)); }

    hide() { this._isShown && (M.trigger(this._element, 'hide.bs.offcanvas').defaultPrevented || (this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.add(re), this._backdrop.hide(), this._queueCallback((() => { this._element.classList.remove(ne, re), this._element.removeAttribute('aria-modal'), this._element.removeAttribute('role'), this._config.scroll || (new zt()).reset(), M.trigger(this._element, ce); }), this._element, !0))); }

    dispose() { this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose(); }

    _initializeBackDrop() {
      const t = Boolean(this._config.backdrop); return new Rt({
        className: 'offcanvas-backdrop', isVisible: t, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: t ? () => { this._config.backdrop !== 'static' ? this.hide() : M.trigger(this._element, le); } : null,
      });
    }

    _initializeFocusTrap() { return new Yt({ trapElement: this._element }); }

    _addEventListeners() { M.on(this._element, 'keydown.dismiss.bs.offcanvas', ((t) => { t.key === 'Escape' && (this._config.keyboard ? this.hide() : M.trigger(this._element, le)); })); }
  ...
  }M.on(document, 'click.bs.offcanvas.data-api', '[data-bs-toggle="offcanvas"]', (function (t) { const e = V.getElementFromSelector(this); if (['A', 'AREA'].includes(this.tagName) && t.preventDefault(), c(this)) return; M.one(e, ce, (() => { l(this) && this.focus(); })); const s = V.findOne(ae); s && s !== e && ue.getInstance(s).hide(), ue.getOrCreateInstance(e).toggle(this); })), M.on(window, 'load.bs.offcanvas.data-api', (() => { for (const t of V.find(ae))ue.getOrCreateInstance(t).show(); })), M.on(window, 'resize.bs.offcanvas', (() => { for (const t of V.find('[aria-modal][class*=show][class*=offcanvas-]'))getComputedStyle(t).position !== 'fixed' && ue.getOrCreateInstance(t).hide(); })), K(ue), m(ue); const _e = new Set(['background', 'cite', 'href', 'itemtype', 'longdesc', 'poster', 'src', 'xlink:href']); const ge = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i; const fe = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i; const me = (t, e) => { const s = t.nodeName.toLowerCase(); return e.includes(s) ? !_e.has(s) || Boolean(ge.test(t.nodeValue) || fe.test(t.nodeValue)) : e.filter(((t) => t instanceof RegExp)).some(((t) => t.test(s))); }; const pe = {
    '*': ['class', 'dir', 'id', 'lang', 'role', /^aria-[\w-]*$/i], a: ['target', 'href', 'title', 'rel'], area: [], b: [], br: [], col: [], code: [], div: [], em: [], hr: [], h1: [], h2: [], h3: [], h4: [], h5: [], h6: [], i: [], img: ['src', 'srcset', 'alt', 'title', 'width', 'height'], li: [], ol: [], p: [], pre: [], s: [], small: [], span: [], sub: [], sup: [], strong: [], u: [], ul: [],
  }; const be = {
    allowList: pe, content: {}, extraClass: '', html: !1, sanitize: !0, sanitizeFn: null, template: '<div></div>',
  }; const ve = {
  ...
  }; const ye = { entry: '(string|element|function|null)', selector: '(string|element)' }; class we extends q {
    ...
    _checkContent(t) { for (const [e, s] of Object.entries(t)) super._typeCheckConfig({ selector: e, entry: s }, ye); }

    _setContent(t, e, s) { const i = V.findOne(s, t); i && ((e = this._resolvePossibleFunction(e)) ? r(e) ? this._putElementInTemplate(a(e), i) : this._config.html ? i.innerHTML = this._maybeSanitize(e) : i.textContent = e : i.remove()); }

    _maybeSanitize(t) { return this._config.sanitize ? (function (t, e, s) { if (!t.length) return t; if (s && typeof s === 'function') return s(t); const i = (new window.DOMParser()).parseFromString(t, 'text/html'); const n = [].concat(...i.body.querySelectorAll('*')); for (const t of n) { const s = t.nodeName.toLowerCase(); if (!Object.keys(e).includes(s)) { t.remove(); continue; } const i = [].concat(...t.attributes); const n = [].concat(e['*'] || [], e[s] || []); for (const e of i)me(e, n) || t.removeAttribute(e.nodeName); } return i.body.innerHTML; }(t, this._config.allowList, this._config.sanitizeFn)) : t; }
  ...
  } const Ae = new Set(['sanitize', 'allowList', 'sanitizeFn']); const Ee = 'fade'; const Ce = 'show'; const Te = '.modal'; const ke = 'hide.bs.modal'; const Se = 'hover'; const Le = 'focus'; const Oe = {
    AUTO: 'auto', TOP: 'top', RIGHT: f() ? 'left' : 'right', BOTTOM: 'bottom', LEFT: f() ? 'right' : 'left',
  }; const Ie = {
    allowList: pe, animation: !0, boundary: 'clippingParents', container: !1, customClass: '', delay: 0, fallbackPlacements: ['top', 'right', 'bottom', 'left'], html: !1, offset: [0, 0], placement: 'top', popperConfig: null, sanitize: !0, sanitizeFn: null, selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', title: '', trigger: 'hover focus',
  }; const De = {
    ...
    dispose() { clearTimeout(this._timeout), M.off(this._element.closest(Te), ke, this._hideModalHandler), this._element.getAttribute('data-bs-original-title') && this._element.setAttribute('title', this._element.getAttribute('data-bs-original-title')), this._disposePopper(), super.dispose(); }

    show() { if (this._element.style.display === 'none') throw new Error('Please use show on visible elements'); if (!this._isWithContent() || !this._isEnabled) return; const t = M.trigger(this._element, this.constructor.eventName('show')); const e = (h(this._element) || this._element.ownerDocument.documentElement).contains(this._element); if (t.defaultPrevented || !e) return; this._disposePopper(); const s = this._getTipElement(); this._element.setAttribute('aria-describedby', s.getAttribute('id')); const { container: i } = this._config; if (this._element.ownerDocument.documentElement.contains(this.tip) || (i.append(s), M.trigger(this._element, this.constructor.eventName('inserted'))), this._popper = this._createPopper(s), s.classList.add(Ce), 'ontouchstart' in document.documentElement) for (const t of [].concat(...document.body.children))M.on(t, 'mouseover', d); this._queueCallback((() => { M.trigger(this._element, this.constructor.eventName('shown')), !1 === this._isHovered && this._leave(), this._isHovered = !1; }), this.tip, this._isAnimated()); }
    ...
    _createPopper(t) { const e = p(this._config.placement, [this, t, this._element]); const i = Oe[e.toUpperCase()]; return s.createPopper(this._element, t, this._getPopperConfig(i)); }
    ...
    ...Ne.Default, content: '', offset: [0, 8], placement: 'right', template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>', trigger: 'click',
  ...
  }m(Me); const je = 'click.bs.scrollspy'; const Fe = 'active'; const $e = '[href]'; const ze = {
    ...
    _maybeEnableSmoothScroll() { this._config.smoothScroll && (M.off(this._config.target, je), M.on(this._config.target, je, $e, ((t) => { const e = this._observableSections.get(t.target.hash); if (e) { t.preventDefault(); const s = this._rootElement || window; const i = e.offsetTop - this._element.offsetTop; if (s.scrollTo) return void s.scrollTo({ top: i, behavior: 'smooth' }); s.scrollTop = i; } }))); }
    ...
    _initializeTargetsAndObservables() { this._targetLinks = new Map(), this._observableSections = new Map(); const t = V.find($e, this._config.target); for (const e of t) { if (!e.hash || c(e)) continue; const t = V.findOne(e.hash, this._element); l(t) && (this._targetLinks.set(e.hash, e), this._observableSections.set(e.hash, t)); } }

    _process(t) { this._activeTarget !== t && (this._clearActiveClass(this._config.target), this._activeTarget = t, t.classList.add(Fe), this._activateParents(t), M.trigger(this._element, 'activate.bs.scrollspy', { relatedTarget: t })); }

    _activateParents(t) { if (t.classList.contains('dropdown-item'))V.findOne('.dropdown-toggle', t.closest('.dropdown')).classList.add(Fe); else for (const e of V.parents(t, '.nav, .list-group')) for (const t of V.prev(e, '.nav-link, .nav-item > .nav-link, .list-group-item'))t.classList.add(Fe); }

    _clearActiveClass(t) { t.classList.remove(Fe); const e = V.find('[href].active', t); for (const t of e)t.classList.remove(Fe); }

    static jQueryInterface(t) { return this.each((function () { const e = Be.getOrCreateInstance(this, t); if (typeof t === 'string') { if (void 0 === e[t] || t.startsWith('_') || t === 'constructor') throw new TypeError(`No method named "${t}"`); e[t](); } })); }
  }M.on(window, 'load.bs.scrollspy.data-api', (() => { for (const t of V.find('[data-bs-spy="scroll"]'))Be.getOrCreateInstance(t); })), m(Be); const qe = 'ArrowLeft'; const We = 'ArrowRight'; const Re = 'ArrowUp'; const Ve = 'ArrowDown'; const Ke = 'active'; const Qe = 'fade'; const Xe = 'show'; const Ye = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]'; const Ue = `.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ${Ye}`; class Ge extends W {
    constructor(t) { super(t), this._parent = this._element.closest('.list-group, .nav, [role="tablist"]'), this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), M.on(this._element, 'keydown.bs.tab', ((t) => this._keydown(t)))); }

    static get NAME() { return 'tab'; }

    show() { const t = this._element; if (this._elemIsActive(t)) return; const e = this._getActiveElem(); const s = e ? M.trigger(e, 'hide.bs.tab', { relatedTarget: t }) : null; M.trigger(t, 'show.bs.tab', { relatedTarget: e }).defaultPrevented || s && s.defaultPrevented || (this._deactivate(e, t), this._activate(t, e)); }

    _activate(t, e) { t && (t.classList.add(Ke), this._activate(V.getElementFromSelector(t)), this._queueCallback((() => { t.getAttribute('role') === 'tab' ? (t.removeAttribute('tabindex'), t.setAttribute('aria-selected', !0), this._toggleDropDown(t, !0), M.trigger(t, 'shown.bs.tab', { relatedTarget: e })) : t.classList.add(Xe); }), t, t.classList.contains(Qe))); }

    _deactivate(t, e) { t && (t.classList.remove(Ke), t.blur(), this._deactivate(V.getElementFromSelector(t)), this._queueCallback((() => { t.getAttribute('role') === 'tab' ? (t.setAttribute('aria-selected', !1), t.setAttribute('tabindex', '-1'), this._toggleDropDown(t, !1), M.trigger(t, 'hidden.bs.tab', { relatedTarget: e })) : t.classList.remove(Xe); }), t, t.classList.contains(Qe))); }

    _keydown(t) { if (![qe, We, Re, Ve].includes(t.key)) return; t.stopPropagation(), t.preventDefault(); const e = [We, Ve].includes(t.key); const s = v(this._getChildren().filter(((t) => !c(t))), t.target, e, !0); s && (s.focus({ preventScroll: !0 }), Ge.getOrCreateInstance(s).show()); }

    _getChildren() { return V.find(Ue, this._parent); }
    ...
    _toggleDropDown(t, e) { const s = this._getOuterElement(t); if (!s.classList.contains('dropdown')) return; const i = (t, i) => { const n = V.findOne(t, s); n && n.classList.toggle(i, e); }; i('.dropdown-toggle', Ke), i('.dropdown-menu', Xe), s.setAttribute('aria-expanded', e); }

    _setAttributeIfNotExists(t, e, s) { t.hasAttribute(e) || t.setAttribute(e, s); }

    _elemIsActive(t) { return t.classList.contains(Ke); }

    _getInnerElement(t) { return t.matches(Ue) ? t : V.findOne(Ue, t); }
    ...
    show() { M.trigger(this._element, 'show.bs.toast').defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add('fade'), this._element.classList.remove(Je), u(this._element), this._element.classList.add(Ze, ts), this._queueCallback((() => { this._element.classList.remove(ts), M.trigger(this._element, 'shown.bs.toast'), this._maybeScheduleHide(); }), this._element, this._config.animation)); }

    hide() { this.isShown() && (M.trigger(this._element, 'hide.bs.toast').defaultPrevented || (this._element.classList.add(ts), this._queueCallback((() => { this._element.classList.add(Je), this._element.classList.remove(ts, Ze), M.trigger(this._element, 'hidden.bs.toast'); }), this._element, this._config.animation))); }
    ...
    _setListeners() { M.on(this._element, 'mouseover.bs.toast', ((t) => this._onInteraction(t, !0))), M.on(this._element, 'mouseout.bs.toast', ((t) => this._onInteraction(t, !1))), M.on(this._element, 'focusin.bs.toast', ((t) => this._onInteraction(t, !0))), M.on(this._element, 'focusout.bs.toast', ((t) => this._onInteraction(t, !1))); }

    _clearTimeout() { clearTimeout(this._timeout), this._timeout = null; }

    static jQueryInterface(t) { return this.each((function () { const e = is.getOrCreateInstance(this, t); if (typeof t === 'string') { if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`); e[t](this); } })); }
  } return K(is), m(is), {
    Alert: Q, Button: Y, Carousel: ct, Collapse: mt, Dropdown: xt, Modal: ie, Offcanvas: ue, Popover: Me, ScrollSpy: Be, Tab: Ge, Toast: is, Tooltip: Ne,
  };
})));
